...
abstract class SchoolsDataSource extends DataSource
{
...
//".$v." school:typeOfEstablishment school:TypeOfEstablishment_TERM_Further_Education .";
	}
	...
	static function getIcon($point)
	{
		switch($point['type'])
		{
			case 'http://education.data.gov.uk/def/school/TypeOfEstablishment_TERM_Higher_Education_Institutions':
				return "http://data.southampton.ac.uk/map-icons/Education/university.png";
			case 'http://education.data.gov.uk/def/school/TypeOfEstablishment_TERM_Further_Education':
				return "http://data.southampton.ac.uk/map-icons/Education/school.png";
			case 'http://education.data.gov.uk/def/school/TypeOfEstablishment_TERM_EY_Setting':
				return "http://data.southampton.ac.uk/map-icons/Education/nursery.png";
		}
		return "http://data.southampton.ac.uk/map-icons/Education/school.png";
	}
}
